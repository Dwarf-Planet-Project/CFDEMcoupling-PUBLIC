...
int main(int argc, char *argv[])
{
    ...
    while (runTime.loop())
    {
        ...
        Info << endl << endl;
        Info << "Number of particles: " << particleCloud.numberOfParticles() << endl;
        ...
        Info << "Current particle angular velocity: " << endl;
        Info << particleCloud.angularVelocity(0) << endl;
        ...
        // ****************************************************************************************** //
        // Volume check (Aycock)
        // This might not work right if particles are continually injected?
        ...
        // // if(volumeRatio < 0.5)
        // // {
        // //     FatalError << "Particle volume has decreased more than 50\% below the nominal value" << endl
